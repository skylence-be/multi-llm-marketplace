...
echo ""
echo "To complete removal, uninstall the agent plugins and package with your package manager:"
echo "  claude plugin uninstall skyline-claude"
echo "  codex plugin remove skyline-codex"
echo "  npm uninstall -g @skylence-ai/skyline   # or: pnpm/yarn/bun remove -g @skylence-ai/skyline"
